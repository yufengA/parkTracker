...
<body>
<section class="main">
	<header class="index">Visitor System<a class="helper" href="#">Help</a></header>
...
<div id="visitor-number-form" title="Single Or Group?">
    ...
    <form action="/Visitor/SignIn" method="post">
    <table>
    <tr><td><h3>Pleased enter how many visitors in your team</h3></td></tr>
   <tr align="center"><td><input class="offset2" type="radio" name="visitor_type" value="single" id="single_radio" checked="checked" />Single</td></tr> 
		 ...
		 <tr><td><input type="text" value="1" placeholder="How many visitor?" id="visitor_num" name="visitor_num" style="display:none" pa></td></tr>  		
